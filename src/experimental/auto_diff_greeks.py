...
def bs_gamma(spot, strike, rate, vol, maturity):
    ...
    Returns:
        Gamma of the option
    """
    return grad(grad(black_scholes_call_price, argnums=0), argnums=0)(
...
if __name__ == "__main__":
    ...
    call_option_price = black_scholes_call_price(
        spot_price, strike_price, risk_free_rate, annual_volatility, time_to_expiry
    )
    call_option_price_1 = bs_price(
        spot_price_a,
        strike_price_a,
        time_to_expiry_a,
        annual_volatility_a,
    ...
    theta_1 = grad(bs_price, argnums=2)(
        spot_price_a,
        strike_price_a,
        time_to_expiry_a,
        annual_volatility_a,
    ...
    vega_1 = grad(bs_price, argnums=3)(
        spot_price_a,
        strike_price_a,
        time_to_expiry_a,
        annual_volatility_a,
